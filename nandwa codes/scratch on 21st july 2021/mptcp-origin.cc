...
// NodeContainer for spine switches
		...
		anim.SetConstantPosition(router.Get(0), 10.0, 0.0);
		anim.SetConstantPosition(router.Get(1), 10.0, 10.0);
		anim.SetConstantPosition(router.Get(2), 20.0, 0.0);
		anim.SetConstantPosition(router.Get(3), 20.0, 10.0);
		anim.SetConstantPosition(host.Get(0), 0.0, 5.0);
		anim.SetConstantPosition(host.Get(1), 30.0 , 5.0);  
