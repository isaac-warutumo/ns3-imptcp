...
NS_LOG_COMPONENT_DEFINE ("usercooperationproject2");
...
uint32_t maxPacketCount = 10800;

UdpClientHelper client1 (i2.GetAddress (0), port1);
UdpClientHelper client2 (i.GetAddress (0), port2);
UdpClientHelper client3 (i2.GetAddress (0), port1);
UdpClientHelper client4 (i2.GetAddress (0), port2);
...
AnimationInterface anim ("ucoop2.xml");
...
anim.EnableIpv4RouteTracking("ucoop2_1.xml", Seconds(0), Seconds(10.0), Seconds(0.5));


AsciiTraceHelper ascii;
phy.EnableAscii(ascii.CreateFileStream ("ucoop2.tr"), enbDevs);
phy.EnablePcap("ucoop2", enbDevs,false);
 ...
 */
 ...
 monitor->SerializeToXmlFile("ucoop2.flowmon", true, true);
