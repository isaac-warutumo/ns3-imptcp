...
//connecting routers and hosts and assign ip addresses
  ...
  OnOffHelper oo = OnOffHelper ("ns3::TcpSocketFactory",
                         InetSocketAddress (i5r1h1.GetAddress (0), port)); //link from router1 to host1
  ...
  ////////////////////////// Use of NetAnim model/////////////////////////////////////////
   ...
   AnimationInterface anim ("mptcp-example-default2.xml");
...
AsciiTraceHelper ascii;
  p2p.EnableAsciiAll (ascii.CreateFileStream ("mptcp-example12.tr"));
