...
NS_LOG_COMPONENT_DEFINE ("usercooperationproject3");
 ...
 */
  ...
  anim.EnableIpv4RouteTracking ("ucoop3_1.xml", Seconds (0), Seconds (10.0), Seconds (0.5));

  AsciiTraceHelper ascii;
  phy.EnableAscii (ascii.CreateFileStream ("ucoop3.tr"), enbDevs);
  phy.EnablePcap ("ucoop3", enbDevs, false);
