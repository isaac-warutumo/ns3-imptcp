...
wifiMac.SetType ("ns3::AdhocWifiMac");
  ...
  NetDeviceContainer l5r0h1 = wifi.Install (wifiPhy, wifiMac, r0h1);
...
"DataMode", StringValue(phyMode), "ControlMode", StringValue (phyMode));
wifiMac.SetType ("ns3::AdhocWifiMac");
  NetDeviceContainer l6r1h1 = wifi.Install (wifiPhy, wifiMac, r1h1);
...
"DataMode", StringValue(phyMode), "ControlMode", StringValue (phyMode));
wifiMac.SetType ("ns3::AdhocWifiMac");  
  NetDeviceContainer l7r2h1 = wifi.Install (wifiPhy, wifiMac, r2h1);
