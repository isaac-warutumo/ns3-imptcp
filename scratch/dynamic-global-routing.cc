...
main (int argc, char *argv[])
{
  ...
  AnimationInterface anim ("netanim/dynamic-routing-example.xml");
  anim.SetConstantPosition(c.Get(0),0,5);
  anim.SetConstantPosition(c.Get(1),0,25);
  anim.SetConstantPosition(c.Get(2),10,15);
  anim.SetConstantPosition(c.Get(3),40,15);
  anim.SetConstantPosition(c.Get(4),20,15);
  anim.SetConstantPosition(c.Get(5),30,15);
  anim.SetConstantPosition(c.Get(6),50,25);
